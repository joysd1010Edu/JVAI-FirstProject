  ...
  return (
    <div className='bg-black px-4 lg:px-0'>
      <div style={{
        ...
        <p className='lg:py-14 text-3xl lg:text-[60px] text-center font-serif font-bold text-white pt-20 mb-16'>Mental Health,<span className='text-[#0056F6] italic font-playfair'> Reimagined</span><br />
          Through AI</p>
