...
const Signup = () => {
  ...
  const onSubmit = (e) => {
    ...
    const confirm_password = e.target["confirm-password"].value;
  ...
  return (
    <div>
      <div className="lg:flex items-center ">
        ...
        <div
          className="md:h-[1025px] md:w-1/2 py-60 md:py-[308px] flex justify-center items-center"
          style={{
        ...
        >
          <div className="w-96 ">
            ...
            <form className="mt-10 w-full text-[#4f565a]" onSubmit={onSubmit}>
              ...
              <button
                type="submit"
                className="bg-[#0056F6] rounded-lg w-full text-white py-3.5 cursor-pointer mb-5"
              >
                Sign up
              </button>
