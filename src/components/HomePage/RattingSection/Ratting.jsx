...
const Ratting = () => {
  ...
  return (
    <div className=" bg-black lg:px-16 px-5">
      ...
      <h1 className="font-semibold text-center text-xl text-blue-500">~~~~ Send Us a Message ~~~~</h1>
      <h1 className="border-t-2 border-b-2 border-cyan-700 text-center font-extrabold w-56 text-xl mx-auto mt-2 text-white mb-10">
        CONTACT FORM
      </h1>
